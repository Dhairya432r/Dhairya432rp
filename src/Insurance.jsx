...
const Insurance = () => {
  ...
  return (
   ...
   <NavBar/>
   <div ><br/><br/></div>
    <div className='box-content mt-5  bg-[#E3E3E3] shadow-xl mb-16 h-[800px] w-full'>
    <div className='lg:flex inline-block md:flex justify-evenly'>
        ...
        <section class="bg-gray-50 h-[750px] lg:h-[750px] lg:w-96 md:h-[750px] md:w-[400px] dark:bg-gray-900">
...
<div className='lg:flex justify-evenly mt-16'>
    ...
    <h1 className='text-[22px] text-[#515252] font-semibold text-center mt-5 mb-4 '>Ensure Best Health</h1>
    <p className='text-[14px] text-[#515252] text-center font-semibold'>To make sure your pet dog gets the best<br/> treatment and health-care whenever required.</p>    
    </div><br/>
    <div className='lg:inline-block'>
    ...
    <h1 className='text-[22px] text-[#515252] font-semibold text-center mt-5 mb-4 '>Save your money</h1>
    <p className='text-[14px] text-[#515252] text-center font-semibold'>Veterinary expenses can be very heavy on your<br/> budget and saving.A pet insurance ensures you<br/> never have to choose between your pet or your <br/>savings and ensures your pet dog is always<br/> covered.</p>
    </div><br/>
    <div className='lg:inline-block'>
    ...
    <h1 className='text-[22px] text-[#515252] font-semibold text-center mt-5 mb-4 '>Avoid the avoidable</h1>
    <p className='text-[14px] text-[#515252] text-center font-semibold'>We know you take utmost care of your pet, but we <br/>can't avoid any accidents and a pet insurance<br/> always there to cover you pet's health.</p>
    </div>
...
<div>
    <div className='box-content bg-white lg:h-[350px] h-[630px] md:h-[700px] mt-0 w-full'>
        <div>
            <h1 className='text-4xl mt-10 font-bold text-MainGray text-center'>What does pet insurance cover?</h1>
        <div className='lg:flex lg:justify-evenly mt-10'>
            ...
            <div className='flex justify-evenly'><h1 className='lg:text-3xl md:text-3xl text-MainGray font-bold'>Hospitalisation Cover</h1><img src='https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcTyWquXqRq_mZ9OVCrJ_65CYPuYqPkx-GtQtA7FkD6uXZMla3HY' className='lg:h-28 h-20 w-20 lg:w-28'/></div>
            ...
            <div className='box-content  bg-white lg:h-[200px] md:h-[250px] md:w-[600px] h-[220px] border-[1px] rounded-md border-gray-300 lg:w-[500px] mx-auto w-[350px]'>
            <div className='flex justify-evenly'><h1 className='lg:text-3xl md:text-3xl text-MainGray font-bold'>Surgery Expenses</h1><img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQR226inoP9Cqhig8aXllY81chm9NPimIHI84LXy073q_QtH2vt' className='lg:h-28 h-20 w-20 lg:w-28'/></div>
...
<h1 className='text-center text-[16.38px] font-bold text-MainGray mb-3'>Common Illness</h1>
<p className='text-center text-MainGray font-[14px] '>From the sniffles to skin issues and <br/>everything in between.</p>
    </div>
    <div>
<img src='https://dm6g3jbka53hp.cloudfront.net/static-images/TPN-Coverage-Icons-1.svg' className='mx-auto'/>
<h1 className='text-center text-[16.38px] font-bold text-MainGray mb-3'>Accidents and Emergencies</h1> 
<p className='text-center text-MainGray font-[14px] '>Here for you when the unpredictable<br/> happens.</p>
    </div>
    <div>
<img src='https://dm6g3jbka53hp.cloudfront.net/static-images/TPN-Coverage-Icons-2.svg' className='mx-auto'/>
<h1 className='text-center text-[16.38px] font-bold text-MainGray mb-3'>Surgery and Hospitalization<br/> cover</h1>
<p className='text-center text-MainGray font-[14px] '>Optional coverage toward the cost of<br/> yearly surgery, diagnostic tests, & <br/>more.</p>
    </div>
    <div>
<img src='https://dm6g3jbka53hp.cloudfront.net/static-images/TPN-Coverage-Icons-3.svg' className='mx-auto'/>
<h1 className='text-center text-[16.38px] font-bold text-MainGray mb-3'>OPD Cover</h1>
<p className='text-center text-MainGray font-[14px] '>Your pet deserves a fighting chance.<br/> We'll help with OPD cover and more<br/> for treatment of specific illnesses by<br/> vet.</p>
    </div>
</div>
<div className='lg:flex  justify-evenly'>
<div>
<img src='https://dm6g3jbka53hp.cloudfront.net/static-images/TPN-Coverage-Icons-5.svg' className='mx-auto'/>
<h1 className='text-center text-[16.38px] font-bold text-MainGray mb-3'>Hereditary and Congenital Disorders</h1>
<p className='text-center text-MainGray font-[14px] '>Like us, pets have unique health histories. Pet<br/> insurance can help you afford covered<br/> treatments for illnesses your pet inherits.</p>
    </div>
    <div>
<img src='https://dm6g3jbka53hp.cloudfront.net/static-images/TPN-Coverage-Icons-6.svg' className='mx-auto'/>
<h1 className='text-center text-[16.38px] font-bold text-MainGray mb-3'>OPD Cover</h1>
<p className='text-center text-MainGray font-[14px] '>Ongoing care can add up. Insurance covers<br/> conditions that aren't pre-existing for the life of<br/> your pet.</p>
    </div>
</div>
...
<div>
    <div className='box-content lg:flex bg-[#D0FFFF] lg:h-[550px]  h-[1000px] lg:w-[1100px] md:w-[600px] w-[350px] mt-10 mx-auto '>
    ...
    <div className='mx-auto md:block lg:block hidden'>
    ...
    <div className='lg:hidden md:hidden inline-block  justify-evenly'>
        <img src='https://dm6g3jbka53hp.cloudfront.net/static-images/TPN-vet-extra-cover.png' className='h-[500px] m  md:w-[350px]'/>
...
{/* Lg & sm mate che */}
<div className='lg:flex justify-evenly lg:mt-4 md:hidden '>
    <div className='lg:inline-block'>
...
<img src='https://dm6g3jbka53hp.cloudfront.net/static-images/TPN-not-covered-icon.svg' className='ml-10'/><h1 className='text-lg font-semibold  text-gray-600'>Medication or treatment not recommended by a Vet</h1>
  ...
  <div class=" lg:block hidden mt-32 ">
   <img src="https://dm6g3jbka53hp.cloudfront.net/static-images/pet-care-pet-insrance-customer-review.jpg" alt="" className="  h-[512px] w-[1100px] mx-auto  " /> 
    <div class=" absolute box-content bg-white  top-[4480px] border-[2px]  rounded-sm  ml-36 px-0  py-10  h-48 w-[350px]">
