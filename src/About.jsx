...
const About = () => {
  ...
  return (
    ...
    <div class="absolute top-0 px-3  lg:py-[182px] py-14  bg-gray-800/50 w-full">
    ...
    <div className='lg:mt-0'>
      <li className='list-none lg:ml-20 lg:text-base  font-bold lg:text-start text-center text-gray-600 mb-3'>Whether you need in-home pet grooming,<br className='lg:hidden md:hidden block'/> pet training, dog walking, pet insurance, pet relocation,<br className='md:block lg:hidden hidden'/> or vet on call, Addopet connects <br className='lg:hidden md:hidden block'/>spet parents with pet <br className='lg:block hidden'/>care heroes who’ll treat<br className='lg:hidden md:hidden block'/> their pet like family.</li>
      <li className='list-none lg:ml-20 lg:text-base font-bold lg:text-start text-center text-gray-600 mb-3'>We understand your pet is family. And you<br className='lg:hidden md:hidden block'/> can trust us to keep your pet happy, healthy, and sweet as ever.</li>
      <li className='list-none lg:ml-20 lg:text-base font-bold lg:text-start text-center text-gray-600 mb-3'>But it’s not just about pet love. Addopet is also committed to making pet care safe, easy, and affordable so that everyone can experience the unconditional <br className='lg:block hidden'/>love of a pet. Whatever you and your furr babies are into, we’re into it too. And we’ve got your back. Anytime. Anywhere.</li>
      <li className='list-none lg:ml-20 lg:text-base font-bold lg:text-start text-center text-gray-600 mb-3'>Addopet donates a portion of every service to Pet NGO’s & Rescue shelters through this program. We also provide meals to shelter dogs in India.</li>

    </div>
    <div className='bg-gray-100 lg:h-[900px] h-[1400px] w-full'>
  ...
  <button onClick={gotoBtn2}
      ...
      >Pet Gromming</button><div><br/></div></Link>
  <Link to ="/Trainning">
  <button onClick={gotoBtn2}
        class="py-2 lg:w-[358px] flex justify-center mx-auto w-[330px] bg-transparent text-orange-500 font-bold border border-orange-500 rounded hover:bg-orange-500 hover:text-white hover:border-transparent transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0"
      >Dog Training</button><div><br/></div></Link>
  <Link to ="#">
  <button 
        class="py-2 lg:w-[358px] flex justify-center mx-auto w-[330px] bg-transparent text-orange-500 font-bold border border-orange-500 rounded hover:bg-orange-500 hover:text-white hover:border-transparent transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0"
      >Call a vets</button><div><br/></div></Link>
      

</div><div className='lg:hidden block  '></div>
...
<Link to ="#">
  <button
        class="py-2 lg:w-[358px] flex justify-center mx-auto w-[330px] bg-transparent text-orange-500 font-bold border border-orange-500 rounded hover:bg-orange-500 hover:text-white hover:border-transparent transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0"
      >Dog Walking</button><div><br/></div></Link>
      <Link to ="/Insurance">
  <button onClick={gotoBtn2}
        class="py-2 lg:w-[358px] flex justify-center mx-auto w-[330px] bg-transparent text-orange-500 font-bold border border-orange-500 rounded hover:bg-orange-500 hover:text-white hover:border-transparent transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0"
      >Pet Insurance</button><div><br/></div></Link>
      <Link to ="#">
  <button 
        class="py-2 lg:w-[358px] flex justify-center mx-auto w-[330px] bg-transparent text-orange-500 font-bold border border-orange-500 rounded hover:bg-orange-500 hover:text-white hover:border-transparent transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0"
      >Pet Relocation</button><div><br/></div></Link>
</div><div className='lg:hidden block '></div>
...
<Link to ="#">
  <button
        class="py-2 lg:w-[358px] flex justify-center mx-auto w-[330px] bg-transparent text-orange-500 font-bold border border-orange-500 rounded hover:bg-orange-500 hover:text-white hover:border-transparent transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0"
      >Rehome a Pet</button><div className='lg:hidden'><br/></div></Link>

      <Link to ="/Adoptpet">
  <button onClick={gotoBtn2}
        class="py-2 lg:w-[358px] flex justify-center mx-auto w-[330px] bg-transparent text-orange-500 font-bold border border-orange-500 rounded hover:bg-orange-500 hover:text-white hover:border-transparent transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0"
      >Adopt a Pets</button><div className='lg:hidden'><br/></div></Link>
</div>
...
<div className='lg:block hidden'><br/><br/></div>
