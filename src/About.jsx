...
const About = () => {
  ...
  return (
    ...
    <div className='lg:mt-0'>
      <li className='list-none lg:ml-20 lg:text-base  font-bold ml-5  text-gray-600 mb-3'>Whether you need in-home pet grooming,<br className='lg:hidden md:hidden block'/> pet training, dog walking, pet insurance, pet relocation,<br className='md:block lg:hidden hidden'/> or vet on call, Addopet connects <br className='lg:hidden md:hidden block'/>spet parents with pet <br className='lg:block hidden'/>care heroes who’ll treat<br className='lg:hidden md:hidden block'/> their pet like family.</li>
      <li className='list-none lg:ml-20 lg:text-base font-bold ml-5  text-gray-600 mb-3'>We understand your pet is family. And you<br className='lg:hidden md:hidden block'/> can trust us to keep your pet happy, healthy, and sweet as ever.</li>
      <li className='list-none lg:ml-20 lg:text-base font-bold ml-5  text-gray-600 mb-3'>But it’s not just about pet love. Addopet is also committed to making pet care safe, easy, and affordable so that everyone can experience the unconditional <br className='lg:block hidden'/>love of a pet. Whatever you and your furr babies are into, we’re into it too. And we’ve got your back. Anytime. Anywhere.</li>
      <li className='list-none lg:ml-20 lg:text-base font-bold ml-5  text-gray-600 mb-3'>Addopet donates a portion of every service to Pet NGO’s & Rescue shelters through this program. We also provide meals to shelter dogs in India.</li>
